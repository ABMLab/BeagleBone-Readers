...
step_forwarder(){
	...
	if [ $ONLINE == 1 ]; then
		...
		echo "This reader sends the reader id *** RID : $RID_SHORT  or  $((16#$RID_SHORT)) ***, which is set in openbeacon_forwarder.c at line 105."
		echo "You may record this number for data analysis."
		oldstr="htons(1234)"
